 ...
 */
public final class Fortune extends Enchantment
{

    private static int MAX_LEVEL = 0;
    private static final String ENCHANTMENT_NAME = "Fortune";
    /**
     ...
     */
    public Fortune(final JavaPlugin plugin)
    {
        super(NamespacedKey.minecraft("fortune"));
        this.plugin = plugin;
